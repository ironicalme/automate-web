...
from automate_ui.apps.api_app.data.requests.fetch_user.response import FetchUserResponse
...
class FetchUser:
    ...
    def answered_by(self, actor: Actor):
        ...
        actor.narrate(f"{actor} attempts to retrieve user with id={self._id}")
