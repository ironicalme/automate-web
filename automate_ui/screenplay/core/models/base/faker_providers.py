...
class CountrySpecificProvider(BaseProvider):
    ...
    def country_state(self, country: str) -> str:
        ...
        try:
            ...
            subdivisions = list(pycountry.subdivisions.get(country_code=country_obj.alpha_2))
            if not subdivisions:
                return self.generator.state()

            valid_subdivisions = [
                sub for sub in subdivisions
                if not any(x in sub.name.lower() for x in ["unknown", "other", "unassigned"])
            ]
        ...
        try:
            ...
            patterns = {
                ...
                "US": lambda: f"{self.generator.random_number(digits=5)}" +
                            (f"-{self.generator.random_number(digits=4)}" if self.generator.boolean(chance_of_getting_true=30) else ""),
    ...
    def county(self) -> str:
        ...
        counties = [
            "Adams", "Allen", "Anderson", "Andrews", "Angelina", "Aransas", "Archer", "Armstrong", "Atascosa",
            ...
            "Garza", "Gillespie", "Glasscock", "Goliad", "Gonzales", "Gray", "Grayson", "Gregg", "Grimes", "Guadalupe",
            "Hale", "Hall", "Hamilton", "Hansford", "Hardeman", "Hardin", "Harris", "Harrison", "Hartley", "Haskell",
            "Hays", "Hemphill", "Henderson", "Hidalgo", "Hill", "Hockley", "Hood", "Hopkins", "Houston", "Howard",
            "Hudspeth", "Hunt", "Hutchinson", "Irion", "Jack", "Jackson", "Jasper", "Jeff Davis", "Jefferson",
            "Jim Hogg", "Jim Wells", "Johnson", "Jones", "Karnes", "Kaufman", "Kendall", "Kenedy", "Kent", "Kerr",
            ...
            "Panola", "Parker", "Parmer", "Pecos", "Polk", "Potter", "Presidio", "Rains", "Randall", "Reagan",
            "Real", "Red River", "Reeves", "Refugio", "Roberts", "Robertson", "Rockwall", "Runnels", "Rusk", "Sabine",
            "San Augustine", "San Jacinto", "San Patricio", "San Saba", "Schleicher", "Scurry", "Shackelford", "Shelby",
            "Sherman", "Smith", "Somervell", "Starr", "Stephens", "Sterling", "Stonewall", "Sutton", "Swisher",
...
class PhoneNumberGenerator:
    ...
    def generate_phone_number(cls, faker, country: str = "Canada") -> str:
        ...
        """
        country_code = cls.COUNTRY_CODES.get(country, "+1")  # Default to +1 if country not found
